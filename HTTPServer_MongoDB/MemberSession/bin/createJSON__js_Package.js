...
try{ SUtilFsWriteStream_Extension_Dev.create_Package_Define__JS( "../js/", "createJS__js.namespace.__define.200_define__files.template", "global." ); }catch( er ){ console.error( "Error1 : " + er ); }
