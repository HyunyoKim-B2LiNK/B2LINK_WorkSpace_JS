...
global.b2link_validation.product.product_basic$addDoc = function( d )
{
	...
	try
	{
		...
		d._id$member_basic = d.register ?  parseInt(0) : 0;
		delete d.register;   
		//수정하기 - 20161111 - 박종하 - product_category 에서 _id 가져 오기. 
		d._id$product_category = d.product_category ? parseInt(0) : 0;
		delete d.product_cateory;
		//수정하기 - 20161111 - 박종하 - brand 에서 _id 가져 오기. 
		d._id$brand_basic = d.brand ? parseInt(0) : 0;
		delete d.brand;
		d.date_register = global.b2link.date.getDateArrayFromDate();
