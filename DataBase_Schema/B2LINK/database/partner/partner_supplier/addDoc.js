function( d )
{
	print( "-- [ S ] - partner_supplier$addDoc():{uint}----------" );

	var col = partner_supplier$_getCol();
	var len = partner_supplier$_findAll().count();
	var r = partner_supplier$validation__addDoc( d );
	...
	if( 0 == r )
	{
		print( "-- [ E ] - partner_supplier$addDoc():{uint}----------return 0;" );
		return 0;
	}

	if( partner_supplier$check__Overlap( r ) )
	{
		print( "-- [ E ] - partner_supplier$addDoc():{uint}----------return 0;" );
		return 0;
	}
	else
	{
		...
		print( "-- [ E ] - partner_supplier$addDoc():{uint}----------return 1;" );
		return 1;
	}
}
