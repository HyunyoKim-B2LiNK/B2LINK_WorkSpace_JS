function()
{
	print( "-- [ S ] - partner_buyer_category$validation__update_id():{uint}----------" );
	...
	{
		print( "-- [ E ] - partner_buyer_category$validation__update_id():{Object}----------return 0;" );
		return 0;
	}
	// type 비교 필요.

	print( "-- [ E ] - partner_buyer_category$validation__update_id():{uint}----------return 0;" );
	return 0;
}
