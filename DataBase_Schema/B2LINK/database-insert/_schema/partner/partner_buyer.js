...
var d = {
	...
	, "properties" : {
		...
		//Register Member ID
		, "_id$member_public__register" : { "description" : "자사 member_public ID(FK) 등록자", "exampleValue" : 0
			, "type" : "uint", "length" : 0
		}

		//Manager Member ID
		, "_id$member_public__manager" : { "description" : "자사 member_public ID(FK) 담당자", "exampleValue" : 0
			, "type" : "uint", "length" : 0
		}
