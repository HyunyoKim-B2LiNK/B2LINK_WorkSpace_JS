...
var d = {
	...
	, "properties" : {
		...
		//Brand Name(Default)
		, "nm" : { "description" : "Brand Name(Default)", "exampleValue" : "비투링크" , "type" : "string", "length" : NumberInt( 0 ) }

		//Brand Name(CN)
		, "nm_cn" : { "description" : "Brand Name(CN)", "exampleValue" : "" , "type" : "string", "length" : NumberInt( 0 ) }

		//Brand Name(KR)
		, "nm_kr" : { "description" : "Brand Name(KR)", "exampleValue" : "비투링크" , "type" : "string", "length" : NumberInt( 0 ) }

		//Brand Name(US)
		, "nm_us" : { "description" : "Brand Name(US)", "exampleValue" : "비투링크" , "type" : "string", "length" : NumberInt( 0 ) }

		//BRAND Homepage URL
		, "url" : { "description" : "Brand Hompage URL", "exampleValue" : "http://www.b2link.co.kr" , "type" : "string", "length" : NumberInt( 0 ) }

		//BRAND Logo Image URL
		, "url_logo" : { "description" : "Brand Logo Image URL", "exampleValue" : "//path/logo.img" , "type" : "string", "length" : NumberInt( 0 ) }

		//BRAND TradeMark Image URL
		, "url_trademark" : { "description" : "Brand TradeMark Image URL", "exampleValue" : "//path/logo.img" , "type" : "string", "length" : NumberInt( 0 ) }
	}
};
