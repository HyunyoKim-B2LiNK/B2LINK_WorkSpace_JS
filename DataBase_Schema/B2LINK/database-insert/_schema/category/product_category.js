var d = {
	...
	, "properties" : {
		...
		, "description" : { "description" : "Product Category Description(Default)", "exampleValue" : "남성을 위한 화장품"
			, "type" : "string", "length" : NumberInt( 0 )
		}

		//Product Category Description(CN)
		, "description_cn" : { "description" : "Product Category Description(CN)", "exampleValue" : "남성을 위한 화장품"
			, "type" : "string", "length" : NumberInt( 0 )
		}

		//Product Category Description(KR)
		, "description_kr" : { "description" : "Product Category Description(KR)", "exampleValue" : "남성을 위한 화장품"
			, "type" : "string", "length" : NumberInt( 0 )
		}

		//Product Category Description(US)
		, "description_us" : { "description" : "Product Category Description(US)", "exampleValue" : "Cosmetic for man"
			, "type" : "string", "length" : NumberInt( 0 )
		}

		//Product Category Name(Default)
		, "nm" : { "description" : "Product Name(Default)", "exampleValue" : "남자화장품"
			, "type" : "string", "length" : NumberInt( 0 )
		}
		...
		, "nm_kr" : { "description" : "Product Name(KR)", "exampleValue" : "남자화장품"
			, "type" : "string", "length" : NumberInt( 0 )
		}

		//Product Category Name(US)
		, "nm_us" : { "description" : "Product Name(US)", "exampleValue" : "For Man"
			, "type" : "string", "length" : NumberInt( 0 )
		}
	}
};
