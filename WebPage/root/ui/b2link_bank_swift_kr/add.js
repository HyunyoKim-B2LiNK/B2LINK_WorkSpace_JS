//----------------------------------------------------------------------------------------------------;
var fileNm = "./ui/b2link_bank_swift_kr/add.js";
...
(function( url, $el_div ){
	...
	/*/
	var _el_input__nm = $f0( $el_div, "nm" );
	var _el_input__nm_kr = $f0( $el_div, "nm_kr" );
	var _el_input__nm_cn = $f0( $el_div, "nm_cn" );
	var _el_input__nm_us = $f0( $el_div, "nm_us" );
	var _el_input__city = $f0( $el_div, "city" );
	var _el_input__branch = $f0( $el_div, "branch" );
	var _el_input__swift_code = $f0( $el_div, "swift_code" );
	/*/
	...
	{
		window.Rh2Log.timeStamp( "-- [ S ] - _evt_mClick__el_btn_add():void----------" );

		window.b2link_service_list_static.bank_swift_kr.add(
			_getDataForQuery()
			, function( result ){
		...
		window.Rh2Log.timeStamp( "-- [ E ] - _evt_mClick__el_btn_add():void----------" );
	};
	...
	{
		window.Rh2Log.timeStamp( "-- [ S ] - _evt_mClick__el_btn_checkOverlap():void----------" );

		window.b2link_service_list_static.bank_swift_kr.check__Overlap(
			_getDataForQuery()
			, function( result ){
				console.log( "==========" );
				console.log( result );
		...
		window.Rh2Log.timeStamp( "-- [ E ] - _evt_mClick__el_btn_checkOverlap():void----------" );
	};
	...
	{
		window.Rh2Log.timeStamp( "-- [ S ] - _evt_mClick__el_btn_cancel():void----------" );
		window.Rh2Log.timeStamp( "-- [ E ] - _evt_mClick__el_btn_cancel():void----------" );
	};
	...
	{
		window.Rh2Log.timeStamp( "-- [ S ] - _getDataForQuery():{Object}----------" );
