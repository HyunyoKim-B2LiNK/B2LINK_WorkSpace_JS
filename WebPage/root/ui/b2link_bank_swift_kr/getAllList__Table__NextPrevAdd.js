//----------------------------------------------------------------------------------------------------;
var fileNm = "./ui/b2link_bank_swift_kr/getAllList__Table__NextPrevAdd.js";
...
(function( url, $el_div ){
	...
	var _el_table = $f0( $el_div, "table" );
		_el_table.js.setData({ idStart : -1, idEnd : 20, limit : 20, maxCount : null
	 		, fn : {
				req_getCount : window.b2link_service_list_static.bank_swift_kr.getCount
				, req_getList_Range__id : window.b2link_service_list_static.bank_swift_kr.getList_Range__id
			}
		});
