//----------------------------------------------------------------------------------------------------;
var fileNm = "./ui/b2link_bank_swift_kr/getAllList.js";
...
(function( url, $el_div ){
	...
	var _req_Data = function()
	{
		...
		window.b2link_service_list_static.bank_swift_kr.getAllList( _res_Data );
	...
	{
		window.Rh2Log.timeStamp( "-- [ S ] - _res_Data():void----------" );
		_setData__tbody( result );
		window.Rh2Log.timeStamp( "-- [ E ] - _res_Data():void----------" );
	};
	...
	{
		window.Rh2Log.timeStamp( "-- [ S ] - _setData__tbody():void----------" );

		console.log( data );

		window.b2link.html.apply_tbody_child( _el_tbody, data );

		window.Rh2Log.timeStamp( "-- [ E ] - _setData__tbody():void----------" );
	};
