//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui/window.b2link_ui.brand_basic.update.js";
 ...
 */
window.b2link_ui.brand_basic.update = function()
{
	window.RayLog.timeStamp( "---- [ S ] - window.b2link_ui.brand_basic.update():{Array}----------" );
	...
	window.RayLog.timeStamp( "---- [ E ] - window.b2link_ui.brand_basic.update():{Array}----------" );
