 ...
 * @param {Function} cbFunction function( data ){};
 */
window.b2link_service_list_static.bank_swift.getAllList = function( countryCode, cbFunction )
{
	window.Rh2Log.timeStamp( "---- [ S ] - window.b2link_service_list_static.bank_swift.getAllList():void----------" );

	window.b2link_service.common._fn_req( _url + "&co=" + countryCode, cbFunction );
