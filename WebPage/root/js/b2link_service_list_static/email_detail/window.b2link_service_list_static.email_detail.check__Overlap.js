...
{
	window.RayLog.timeStamp( "---- [ S ] - window.b2link.service.res$email_detail$check__Overlap():void----------" );
	console.log( result );

	var r = JSON.parse( result );
	cbFunction( r );

	window.RayLog.timeStamp( "---- [ E ] - window.b2link.service.res$email_detail$check__Overlap():void----------" );
};
