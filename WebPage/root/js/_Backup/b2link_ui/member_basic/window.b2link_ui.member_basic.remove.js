//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui/window.b2link_ui.member_basic.remove.js";
 ...
 */
window.b2link_ui.member_basic.remove = function()
{
	window.RayLog.timeStamp( "---- [ S ] - window.b2link_ui.member_basic.remove():{Array}----------" );
	...
	window.RayLog.timeStamp( "---- [ E ] - window.b2link_ui.member_basic.remove():{Array}----------");
