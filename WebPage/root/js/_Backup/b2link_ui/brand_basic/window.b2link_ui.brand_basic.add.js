//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui/window.b2link_ui.brand_basic.add.js";
 ...
 */
window.b2link_ui.brand_basic.add = function()
{
	window.RayLog.timeStamp( "---- [ S ] - window.b2link_ui.brand_basic.add():{Array}----------" );
	...
	window.RayLog.timeStamp( "---- [ E ] - window.b2link_ui.brand_basic.add():{Array}----------" );
