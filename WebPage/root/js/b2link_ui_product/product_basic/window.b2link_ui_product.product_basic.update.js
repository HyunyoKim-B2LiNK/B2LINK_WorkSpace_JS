...
{
	window.RayLog.timeStamp( "---- [ S ] - window.b2link_ui_product.product_basic.update():{Array}----------" );
	...
	window.RayLog.timeStamp( "---- [ E ] - window.b2link_ui_product.product_basic.update():{Array}----------" );
