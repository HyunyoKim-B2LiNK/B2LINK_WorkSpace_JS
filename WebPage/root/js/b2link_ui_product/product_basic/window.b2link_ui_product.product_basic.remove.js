//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui_product/product_basic/window.b2link_ui_product.product_basic.remove.js";
...
{
	window.RayLog.timeStamp( "---- [ S ] - window.b2link_ui_product.product_basic.remove():{Array}----------" );
	var d = {
		url : window.b2link.STATIC.CONFIG.URL.UI.B2LINK_PRODUCT_BASIC
		, nm : "remove"
		, css_url : "./css_ui/"
		, css_front_nm : "div__product_basic-"
		, key : "product_basic$remove"
	};
	...
	window.RayLog.timeStamp( "---- [ E ] - window.b2link_ui_product.product_basic.remove():{Array}----------" );
