//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link/element/window.b2link.element.setPosition_CenterMiddle_FromWindow.js";
...
{
	window.TtwLog.timeStamp( "---- [ S ] - window.b2link.element.setPosition_CenterMiddle_FromWindow():void----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.b2link.element.setPosition_CenterMiddle_FromWindow():void----------" );
};
