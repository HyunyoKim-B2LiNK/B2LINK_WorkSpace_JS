//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui_list_static/window.b2link_ui_list_static.email_detail.remove.js";
...
{
	window.RayLog.timeStamp( "---- [ S ] - window.b2link_ui_list_static.email_detail.remove():{Array}----------" );
	...
	window.RayLog.timeStamp( "---- [ E ] - window.b2link_ui_list_static.email_detail.remove():{Array}----------");
