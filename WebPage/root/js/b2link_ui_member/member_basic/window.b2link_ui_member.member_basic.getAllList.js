//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui_member/window.b2link_ui_member.member_basic.getAllList.js";
...
{
	window.TtwLog.timeStamp( "---- [ S ] - window.b2link_ui_member.member_basic.getAllList():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.b2link_ui_member.member_basic.getAllList():{Array}----------" );
