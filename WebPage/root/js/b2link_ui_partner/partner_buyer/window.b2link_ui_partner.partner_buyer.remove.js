//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui_partner/partner_buyer/window.b2link_ui_partner.partner_buyer.remove.js";
 ...
 */
window.b2link_ui_partner.partner_buyer.remove = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.b2link_ui_partner.partner_buyer.remove():{Array}----------" );
	var d = {
		url : window.b2link.STATIC.CONFIG.URL.UI.B2LINK_PARTNER_BUYER
		, nm : "remove"
		, css_url : "./css_ui/"
		, css_front_nm : "div__partner_buyer-"
		, key : "partner_buyer$remove"
	};
...
//	}
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.b2link_ui_partner.partner_buyer.remove():{Array}----------" );
