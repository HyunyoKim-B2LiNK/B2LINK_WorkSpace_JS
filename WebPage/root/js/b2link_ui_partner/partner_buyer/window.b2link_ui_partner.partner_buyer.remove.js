...
{
	window.RayLog.timeStamp( "---- [ S ] - window.b2link_ui_partner.partner_buyer.remove():{Array}----------" );
	var d = {
	...
	window.RayLog.timeStamp( "---- [ E ] - window.b2link_ui_partner.partner_buyer.remove():{Array}----------" );
