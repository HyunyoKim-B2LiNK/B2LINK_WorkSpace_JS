//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui_partner/partner_delivery/window.b2link_ui_partner.partner_delivery.remove.js";
 ...
 */
window.b2link_ui_partner.partner_delivery.remove = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.b2link_ui_partner.partner_delivery.remove():{Array}----------" );
	var d = {
		url : window.b2link.STATIC.CONFIG.URL.UI.B2LINK_PARTNER_DELIVERY
		, nm : "remove"
		, css_url : "./css_ui/"
		, css_front_nm : "div__partner_delivery-"
		, key : "partner_delivery$remove"
	};
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.b2link_ui_partner.partner_delivery.remove():{Array}----------" );
