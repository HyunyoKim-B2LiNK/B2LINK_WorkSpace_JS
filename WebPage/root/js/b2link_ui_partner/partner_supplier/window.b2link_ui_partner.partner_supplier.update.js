//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui_partner/partner_supplier/window.b2link_ui_partner.partner_supplier.update.js";
 ...
 */
window.b2link_ui_partner.partner_supplier.update = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.b2link_ui_partner.partner_supplier.update():{Array}----------" );
	var d = {
		url : window.b2link.STATIC.CONFIG.URL.UI.B2LINK_PARTNER_SUPPLIER
		, nm : "update"
		, css_url : "./css_ui/"
		, css_front_nm : "div__partner_supplier-"
		, key : "partner_supplier$update"
	};
...
//	}
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.b2link_ui_partner.partner_supplier.update():{Array}----------" );
