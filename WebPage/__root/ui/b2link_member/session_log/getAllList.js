//----------------------------------------------------------------------------------------------------;
var fileNm = "./ui/b2link_member/member_session_log/getAllList__nm.js";
...
(function(){
	...
	var $el_div = $d.getElementById( "div_1__member_session$getAllList__nm" );

	var _el_table_cancle = $d.getElementById( "table__member_session$getAllList__nm" );
	...
	window.b2link.service.req$member_session$getAllList__nm(
		function( result ){
			console.log( "window.b2link.service.req$member_session$getAllList__nm result : " );
			console.log( result );

			var _t = $d.getElementById( "tbody__member_session$getAllList__nm" );
			var html = "<tr>";
			var td = "<td>$d</td>";
			var a = result;
			var io;
