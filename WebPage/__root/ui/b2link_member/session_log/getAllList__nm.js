//----------------------------------------------------------------------------------------------------;
var fileNm = "./ui/b2link_member/member_session_log/getAllList.js";
...
(function(){
	...
	var $el_div = $d.getElementById( "div_1__member_session_log$getAllList" );

	var _el_table_cancle = $d.getElementById( "table__member_session_log$getAllList" );
	...
	window.b2link.service.req$member_session_log$getAllList(
		function( result ){
			console.log( "window.b2link.service.req$member_session_log$getAllList result : " );
			console.log( result );

			var _t = $d.getElementById( "tbody__member_session_log$getAllList" );
			var html = "<tr>";
			var td = "<td>$d</td>";
			var a = result;
			var io;
