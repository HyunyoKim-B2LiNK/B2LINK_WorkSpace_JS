 ...
 * @function
 */
window.b2link_ui.member_basic.getAllList__nm = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.b2link_ui.member_basic.getAllList__nm ():void----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.b2link_ui.member_basic.getAllList__nm ():void----------" );
};
